# TypeScript + Vite + Vue + Vue-Router + Pinia + TailwindCSS + Shadcn Starter Template
...
# UI tools
npm install -y tailwindcss @iconify/vue @vueuse/core
...
# Initializing shadcn-vue
npx shadcn-vue@latest init
# Adding all shadcn-vue components
...
```sh
git init .
npx degit jchrist77/vue-shadcn-starter
```